...
print("Welcome to the text based adventure game where your curiousity and your willingness to help people will decide to win the game or not.")     
time.sleep(1.5)
print("You can quit the game anytime you wish but typing quit or exit at any of the imput promt stages.")
time.sleep(1.5)
print("Without further adieu, let's begin the game!!!")  
print("\n")
print("\n")
time.sleep(3)
home(items,primograms)
